...
*/
SurfaceSegmentation::SurfaceSegmentation(pcl::PointCloud<pcl::PointXYZ>::Ptr icloud)
{
  input_cloud_ =  pcl::PointCloud<pcl::PointXYZ>::Ptr(new pcl::PointCloud<pcl::PointXYZ>);
...
*/
void SurfaceSegmentation::addCloud(pcl::PointCloud<pcl::PointXYZ>::Ptr icloud)
{
                                                                     ...
                                                                     &colored_cloud)
{
  ...
  rg.setSmoothnessThreshold (100.0 / 180.0 * M_PI);
  rg.setCurvatureThreshold(100.0);
...
Mesh SurfaceSegmentation::computeMesh()
{
  ...
  pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_with_colors(new pcl::PointCloud<pcl::PointXYZ>);
  pcl::PointCloud<pcl::PointXYZRGBNormal>::Ptr cloud_with_normals(new pcl::PointCloud<pcl::PointXYZRGBNormal>);

  for(const auto& pt : input_cloud_->points)
  {
    pcl::PointXYZ npt(0,255,0);
    npt.x = pt.x;
    npt.y = pt.y;
    npt.z = pt.z;
...
bool SurfaceSegmentation::applyConcaveHull(pcl::PointCloud<pcl::PointXYZ>::Ptr& in, pcl::PolygonMesh& mesh)
{
